...
class _PrivacidadWidgetState extends State<PrivacidadWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'privacidad'});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<TextosRecord>>(
      stream: queryTextosRecord(
        queryBuilder: (textosRecord) => textosRecord.where(
          'titulo',
      ...
      builder: (context, snapshot) {
        ...
        List<TextosRecord> privacidadTextosRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final privacidadTextosRecord = privacidadTextosRecordList.isNotEmpty
            ? privacidadTextosRecordList.first
            : null;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('PRIVACIDAD_chevron_left_rounded_ICN_ON_T');
                  context.pop();
                },
              ),
              title: Text(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'PRIVACIDAD_PAGE_darkMode_Logo_ON_TAP');
                    ...
                    Padding(
                      padding: EdgeInsets.all(10.0),
                      child: Html(
                        data: privacidadTextosRecord!.texto,
